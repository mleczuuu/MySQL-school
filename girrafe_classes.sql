...
CREATE TABLE `classes` (
  ...
  CONSTRAINT `classes_ibfk_1` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`),
...
INSERT INTO `classes` VALUES (1,'math 101',1,3),(2,'prof english',2,1),(3,'easy geo',3,2),(4,'psychics 101',4,4);
